...
export const statesData = [
  ...
  // List of Indian Districts aith key of state
  export const districtsData = {
    ...
    Bihar: [
      ...
      { value: "Munger (Monghyr)", label: "Munger (Monghyr)" },
      { value: "Muzaffarpur", label: "Muzaffarpur" },
      { value: "Nalanda", label: "Nalanda" },
      { value: "Nawada", label: "Nawada" },
      { value: "Patna", label: "Patna" },
      { value: "Purnia (Purnea)", label: "Purnia (Purnea)" },
    ...
    "Chandigarh (UT)": [{ value: "Chandigarh", label: "Chandigarh" }],
    Chhattisgarh: [
      ...
      { value: "Kanker (North Bastar)", label: "Kanker (North Bastar)" },
    ...
    Gujarat: [
      ...
      { value: "Banaskantha (Palanpur)", label: "Banaskantha (Palanpur)" },
      ...
      { value: "Narmada (Rajpipla)", label: "Narmada (Rajpipla)" },
      { value: "Navsari", label: "Navsari" },
      { value: "Panchmahal (Godhra)", label: "Panchmahal (Godhra)" },
    ...
    "Himachal Pradesh": [
      ...
      { value: "Sirmaur (Sirmour)", label: "Sirmaur (Sirmour)" },
    ...
    "West Bengal": [
      ...
      { value: "Burdwan (Bardhaman)", label: "Burdwan (Bardhaman)" },
